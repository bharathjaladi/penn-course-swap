...
export default class CompleteForm3 extends React.Component {
  constructor(props) {
    super(props);
      ...
      <Style>
       ...
       `}
        <div>
          ...
          <div>
            <form method="post" action="/complete3" className="pure-form pure-form-aligned">
              <fieldset>
                <div className="pure-test">
                  <button type="submit" className="pure-button pure-input-rounded oswald3">Yes!</button>
                </div>
              </fieldset>
            </form>
          </div></div></Style>
